...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			<div class="navbar">
				<div class="navbar-inner" style="position: fixed;right: 0;left: 0;z-index: 1030;margin-bottom: 0;">
					<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="carousel slide" id="carousel-207101">
				<ol class="carousel-indicators">
					<li data-slide-to="0" data-target="#carousel-207101">
					</li>
					<li data-slide-to="1" data-target="#carousel-207101" class="active">
					</li>
					<li data-slide-to="2" data-target="#carousel-207101">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="item">
						<img alt="" src="__IMAGE__/1.jpg" />
				...
				</div> <a data-slide="prev" href="#carousel-207101" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-207101" class="right carousel-control">›</a>
			</div>
	...
	<div class="row-fluid">
		<div class="span4">
			<div class="accordion" id="accordion-518541">
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-518541" href="#accordion-element-167637">选项卡 #1</a>
					</div>
					<div id="accordion-element-167637" class="accordion-body collapse">
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-518541" href="#accordion-element-954934">选项卡 #2</a>
					</div>
					<div id="accordion-element-954934" class="accordion-body in collapse">
						<div class="accordion-inner">
							功能块...
						</div>
					</div>
		...
		<div class="span8">
			<div class="row-fluid">
				<div class="span12">
					<img alt="140x140" src="__IMAGE__/a.jpg" />
				</div>
			</div>
			<dl>
				<dt>
	...
	<div class="row-fluid">
		<div class="span8">
			<div class="media">
				 <a href="#" class="pull-left"><img src="__IMAGE__/a_002.jpg" class="media-object" alt='' /></a>
		...
		<div class="span4">
			<img alt="140x140" src="__IMAGE__/a.jpg" /><img alt="140x140" src="__IMAGE__/a.jpg" />
		</div>
	</div>
	<div class="row-fluid">
		<div class="span12">
...
<!-- <div class="container">
	<div class="row">
		<div class="span12">
			<div class="navbar" style="position: fixed;right: 0;left: 0;z-index: 1030;margin-bottom: 0;">
	...
	<div class="row">
		<div class="span12">
			<div class="carousel slide" id="carousel-207101">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-207101">
					</li>
					<li data-slide-to="1" data-target="#carousel-207101">
					</li>
					<li data-slide-to="2" data-target="#carousel-207101">
					</li>
				</ol>
